...
public class Tp2Application implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        studentRepository.save(
                new Student(null,"A1","ATK",new Date(),true,null,null));
        studentRepository.save(
                new Student(null,"A2","Ibtissame",new Date(),true,null,null));
        studentRepository.save(
                new Student(null,"A3","Souhail",new Date(),false,null,null));
        studentRepository.save(
                new Student(null,"A4","Youssef",new Date(),true,null,null));
        studentRepository.save(
                new Student(null,"A5","Sofia",new Date(),false,null,null));
